...
def on_on_score():
    game.game_over(True)
    game.set_game_over_message(True, "You Have Defended Earth")
...
def on_on_overlap2(sprite3, otherSprite2):
    ...
    mySprite3.set_position(randint(0, 100), randint(0, 100))
    mySprite3.set_position(randint(0, 100), randint(0, 100))
    mySprite3.set_position(randint(0, 100), randint(0, 100))
...
tiles.set_wall_at(tiles.get_tile_location(1, 1), True)
scene.set_background_image(img("""
